...
export default function Hero() {
  const words = [
    ...
    "JavaScript Developer & Android Developer",
    "Learning MARN Stack",
  ];
...
const profile = {
    name: 'Harsh Raj',
    title: 'Web Developer | Android Developer | Java Developer',
    skills: [
        'React', 'HTML', 'CSS', 'JavaScrip',
        'Android', 'Java','Git'
    ],
    hardWorker: true,
    quickLearner: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript lover 🚀 | Android Developer 🔧 | Crafting frameworks
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/Harshkr54"
                ...
                {/* Contact Button */}
                <a
                   href="/resume/Harsh Raj Resume.pdf"// Update this path to your actual resume file
                   download="Harsh-Raj-Resume.pdf"  // This forces download with specified filename
